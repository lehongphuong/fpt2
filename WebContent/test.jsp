...
<head>
    ...
    <!-- thu vien new -->
	<link rel='stylesheet' id='validate-engine-css-css'  href='https://mdbootstrap.com/wp-content/plugins/wysija-newsletters/css/validationEngine.jquery.css?ver=2.7.8' type='text/css' media='all' />
<link rel='stylesheet' id='ajax-auth-style-css'  href='https://mdbootstrap.com/wp-content/themes/mdbootstrap4/css/ajax-auth-style.css?ver=4.7.3' type='text/css' media='all' />
...
<link rel='stylesheet' id='contact-form-7-css'  href='https://mdbootstrap.com/wp-content/plugins/contact-form-7/includes/css/styles.css?ver=4.7' type='text/css' media='all' />
<link rel='stylesheet' id='cookie-consent-style-css'  href='https://mdbootstrap.com/wp-content/plugins/uk-cookie-consent/assets/css/style.css?ver=4.7.3' type='text/css' media='all' />
<link rel='stylesheet' id='woocommerce-layout-css'  href='//mdbootstrap.com/wp-content/plugins/woocommerce/assets/css/woocommerce-layout.css?ver=2.6.14' type='text/css' media='all' />
<link rel='stylesheet' id='woocommerce-smallscreen-css'  href='//mdbootstrap.com/wp-content/plugins/woocommerce/assets/css/woocommerce-smallscreen.css?ver=2.6.14' type='text/css' media='only screen and (max-width: 768px)' />
<link rel='stylesheet' id='woocommerce-general-css'  href='//mdbootstrap.com/wp-content/plugins/woocommerce/assets/css/woocommerce.css?ver=2.6.14' type='text/css' media='all' />
<link rel='stylesheet' id='wsl-widget-css'  href='https://mdbootstrap.com/wp-content/plugins/wordpress-social-login/assets/css/style.css?ver=4.7.3' type='text/css' media='all' />
<link rel='stylesheet' id='compiled.css-css'  href='https://mdbootstrap.com/wp-content/themes/mdbootstrap4/css/compiled.min.css?ver=4.7.3' type='text/css' media='all' />
<link rel='stylesheet' id='style.css-css'  href='https://mdbootstrap.com/wp-content/themes/mdbootstrap4/style.css?ver=4.7.3' type='text/css' media='all' />
<script type='text/javascript' src='https://mdbootstrap.com/wp-includes/js/jquery/jquery.js?ver=1.12.4'></script>
<script type='text/javascript' src='https://mdbootstrap.com/wp-includes/js/jquery/jquery-migrate.min.js?ver=1.4.1'></script>
<script type='text/javascript' src='https://mdbootstrap.com/wp-content/themes/mdbootstrap4/js/jquery.validate.js?ver=4.7.3'></script>
	<!-- end thu vien new -->
    ...
    <meta property="og:image" content="https://mdbootstrap.com/img/Live/MDB/dashboard-na-fb-share.jpg">
    <meta property="og:url" content="https://mdbootstrap.com/live/_MDB/templates/Admin/analytics.html">
	...
	<meta name="twitter:image" content="https://mdbootstrap.com/img/Live/MDB/dashboard-na-fb-share.jpg" />
        ...
        <div class="inner">
            ...
            <div id="bg-option">
                ...
                <div class="bg-img-preview">
                    <label for="radio12"><img class="img-fluid" src="https://mdbootstrap.com/img/Others/sidenav1-min.jpg" alt="Option 1"></label>
                    <label for="radio22"><img class="img-fluid" src="https://mdbootstrap.com/img/Others/sidenav2-min.jpg" alt="Option 2"></label>
                    <label for="radio32"><img class="img-fluid" src="https://mdbootstrap.com/img/Others/sidenav3-min.jpg" alt="Option 3"></label>
                    <label for="radio42"><img class="img-fluid" src="https://mdbootstrap.com/img/Others/sidenav4-min.jpg" alt="Option 4"></label>
                </div>
    ...
    <main class="">
        <div class="container-fluid">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="row card-block pt-3">
                                            ...
                                            <div class="col-md-6 text-center">
                                                ...
                                                <!--Summary-->
                                                <p>Total sales: <strong>2000$</strong> <button type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Total sales in the given period"><i class="fa fa-question"></i></button></p>
                                                <p>Average sales: <strong>100$</strong> <button type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Average daily sales in the given period"><i class="fa fa-question"></i></button></p>

                                                <!--Change chart-->
                                                <span class="min-chart" id="chart-sales" data-percent="76"><span class="percent"></span></span>
                                                <h5><span class="badge green">Change <i class="fa fa-arrow-circle-up"></i></span><button type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Percentage change compared to the same period in the past"><i class="fa fa-question"></i></button></h5>
                                            </div>
                                            <!--/Second column-->
            ...
            <section class="section section-intro">
                ...
                <h2 class="mb-1 text-center">Manage your offers</h2>
                    ...
                    <div class="col-md-4 mb-r">
                        ...
                        <div class="card card-cascade narrower">
                            ...
                            <div class="card-block text-center">
                                <!--Category & Title-->
                                <a href="" class="text-muted"><h5>Category</h5></a>
                                ...
                                <div class="card-footer">
                                    ...
                                    <span class="right">
                            <a data-toggle="tooltip" data-placement="top" title="Add to Cart"><i class="fa fa-eye"></i></a>
                            <a data-toggle="tooltip" data-placement="top" title="Share"><i class="fa fa-pencil"></i></a>
                            <a data-toggle="tooltip" data-placement="top" title="Added to Wishlist"><i class="fa fa-remove"></i></a>
                        </span>
                                </div>
            ...
            <section class="section section-intro">
                ...
                <div class="row mb-3">
                            ...
                            <div class="admin-panel info-admin-panel">
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="list-group">
                                        <a href="#" class="list-group-item">Cras justo odio <i class="fa fa-wrench ml-auto" data-toggle="tooltip" data-placement="top" title="Click to fix"></i></a>
                                        <a href="#" class="list-group-item">Dapibus ac facilisi<i class="fa fa-wrench ml-auto" data-toggle="tooltip" data-placement="top" title="Click to fix"></i></a>
                                        <a href="#" class="list-group-item">Morbi leo risus <i class="fa fa-wrench ml-auto" data-toggle="tooltip" data-placement="top" title="Click to fix"></i></a>
                                        <a href="#" class="list-group-item">Porta ac consectet<i class="fa fa-wrench ml-auto" data-toggle="tooltip" data-placement="top" title="Click to fix"></i></a>
                                        <a href="#" class="list-group-item">Vestibulum at eros <i class="fa fa-wrench ml-auto" data-toggle="tooltip" data-placement="top" title="Click to fix"></i></a>
                                    </div>
                    ...
                    <div class="col-md-4 mb-1">
                        ...
                        <!--Card-->
                        <div class="card card-cascade narrower">
                            <div class="admin-panel danger-admin-panel">
                                <!--Card image-->
                                <div class="view">
